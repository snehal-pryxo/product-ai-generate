-- CreateTable
CREATE TABLE `collection_generated_contents` (
...
-- CreateIndex
CREATE UNIQUE INDEX `CollectionGeneratedContent_shop_collectionId_key`
  ON `collection_generated_contents`(`shop`, `collectionId`);

-- CreateIndex
CREATE INDEX `CollectionGeneratedContent_shop_updatedAt_idx`
